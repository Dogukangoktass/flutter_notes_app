...
import '../addupdatescreen/add_update_screen.dart';
          ...
          Expanded(child: FutureBuilder(
            ...
            builder: (context, AsyncSnapshot<List<TodoModel>> snapshot){
              if(!snapshot.hasData || snapshot.data==null){
                ...
                { return Center(
                  child: Text("No task found! ${snapshot.data!.length.toString()} "  , style: TextStyle(
                    fontSize: 25,
                 ...
                 itemBuilder: (context, index){
                   ...
                   return Dismissible(key: ValueKey<int>(todoId), direction: DismissDirection.endToStart,
                       ...
                       child: Column(
                         children: [
                           ListTile(
                            ...
                            title: Padding( padding: EdgeInsets.only(bottom: 10), child: Text(todoTitle,
                                style: TextStyle(fontSize:20))),
                             subtitle: Text(todoDesc, style: TextStyle(fontSize: 15)),
                           ),
                           Divider(
                             color: Colors.black,
                             thickness: 0.6,
                           ...
                           Row(
                             ...
                             children: [
                               ...
                               child: Text(todoDT, style: TextStyle(fontSize: 14)),
                               ),
                               InkWell(onTap: (){
                               ...
                               child: Icon(Icons.edit_note_rounded, size: 30,color: Colors.green,),)
                             ],
                           )
                         ],
                       ),
